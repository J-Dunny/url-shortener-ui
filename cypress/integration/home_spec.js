describe("Home page display and userflow", () => {
    ...
    it("Should correctly add new short URL to dom and POST data", () => {
        ...
        cy.intercept('POST', "http://localhost:3001/api/v1/urls", 
            ...
            {   id: 25, 
                long_url: 'https://images.unsplash.com/photo-1531898418865-480b7090470f?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=934&q=803452345324', 
                short_url: 'http://localhost:3001/useshorturl/13453454', 
                title: 'Awesome photo 2'
            }
        
        ).as("post-urls")
        .get('button').click()
        .get('.url').contains("Awesome photo 2")
